...
/**
  ...
  */
@Since("1.3.0")
class PowerIterationClusteringNew private[clustering] (
                                                     private var k: Int,
...
//    val constraintsfile = "/Users/User/IdeaProject/graphx-experiment/input/twitter-small-labeled.txt"
//    val constrained_similarities = filter_constraints(constraintsfile, graph)
//    val w = normalize(constrained_similarities)
